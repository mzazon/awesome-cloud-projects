...
<body>
    <div class="container">
        ...
        <p>This instance is part of the <strong>ec2-fleet-demo</strong> demonstration.</p>
                ...
                "collect_list": [
                    {
                        ...
                        "log_group_name": "/aws/ec2/fleet/ec2-fleet-demo",
...
# Signal completion
/opt/aws/bin/cfn-signal -e $? --stack ec2-fleet-demo --resource AutoScalingGroup --region $(curl -s http://169.254.169.254/latest/meta-data/placement/region) || true